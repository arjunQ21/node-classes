...
//setImage
  const setImage = catchAsync (async function(req,res){
    ...
    const existingGroupMember=await groupMember.find({userId: currentId, groupId: groupId})
  ...
  const messageController = { sendMessage, viewMessage, editMessage, deleteMessage, setImage}
